...
<div class="row mt-3">
	<div class="col">
		<div class="card">
			<div class="card-body">
			<h4 class="header-title">Data Users Management</h4>
			<a href="<?php echo base_url('admin/form/'); ?>" class="btn-info btn" target="_blank"><i class="fa fa-plus"></i> &nbsp;Add Menu</a>
				<div class="box-content">
					<div class="data-tables mt-3">
						<table id="dataTable" class="text-center">
							...
							<tbody>
							<?php foreach ($get_admin as $record): ?>
									<tr>
										<td>
											<a href="<?php echo base_url('admin/form/'.$record->id); ?>" ><i class="fa fa-edit" style="font-size: 24px;"></i></a>
												...
												<div class="modal-dialog" role="document">
													<div class="modal-content">
														...
														<div class="modal-footer">
															...
															<a href="<?php echo base_url('admin/deletec/'.$record->id); ?>" class="btn btn-danger">Hapus</a>
														</div>
													</div>
												</div>
											</div>
