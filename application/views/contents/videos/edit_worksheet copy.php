     ...
     <div class="col-12 mt-5">
      <div class="card">
       <div class="card-body">
    	...
    	<div class="box-content">
       <form method="post" id="formupload" enctype="multipart/form-data" action="<?php echo base_url($this->utama)?>/submit_worksheet">
    		...
    		<div class="form-group">
            <button type="button" class="btn pull-right" onclick='uploadFileWorksheet();'>Submit</button>
            </form>
             </div>
    	</div>
...
function uploadFileWorksheet() {
  ...
  ajax.open("POST", "<?php echo base_url()?>videos/upload_worksheet/<?php echo $lang?>");
  ajax.send(formdata);
}
