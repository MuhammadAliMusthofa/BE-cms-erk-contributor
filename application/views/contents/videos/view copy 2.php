					...
					<div class="data-tables mt-3">
						<table id="dataTable" class="text-center">
							...
							<?php foreach ($get_video as $record): ?>
									<tr>
										<td>
											<!-- <a href="<?php echo base_url('videos/detail/'.$record->id); ?>" target="_blank"><i class="fa fa-eye" style="font-size: 24px;"></i></a> -->
											<a href="<?php echo base_url('videos/create/'.$record->id); ?>" target="_blank"><i class="fa fa-edit" style="font-size: 24px;"></i></a>
