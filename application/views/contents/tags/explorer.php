        ...
        <div class="card-body">
          ...
          <div class="tab-content mt-3" id="nav-tabContent">
              <?php foreach($getparents->result() as $parent) { ?>
                  ...
                  <!-- <a href="<?php echo base_url('tags/form/0/').$parent->id ?>"><i class="fa fa-plus" title="Add Tag"></i>Tambah Data</a> -->
                  <button type="button" class="btn btn-primary" onclick="window.location='<?php echo base_url('tags/form/0/').$parent->id ?>'">
                      <i class="fa fa-plus" title="Add Tag"></i> Tambah Data <?php echo $parent->title ?>
                  </button>
