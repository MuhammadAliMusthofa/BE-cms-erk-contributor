		...
		<div class="card">
			...
			<h4 class="header-title">Data Menu</h4>
				<button type="button" class="btn-info btn" data-toggle="modal" data-target="#pdfUploadModal">
					<i class="fa fa-plus"></i> Tambah Data Worksheet
				</button>
					...
					<div class="modal-dialog modal-lg" role="document">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title" id="pdfUploadModalLabel">Tambah Data Worksheet</h5>
							...
							<div class="modal-body">
								<form method="post" action="<?php echo base_url('capaian_pembelajaran/add_cp'); ?>" enctype="multipart/form-data">
									...
									<div class="form-group">
										<label for="pdf_files">File Worksheet</label>
						...
						<table id="dataTable" class="text-center">
							...
							<tbody>
								...
								<tr>
									...
									<td><?php echo $record->jenjang ?? 'Belum Memilih Jenjang'; ?></td>
