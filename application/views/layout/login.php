...
<style>
  ...
  .card {
    box-shadow: 0 14px 28px rgba(189, 189, 189, 0.25), 0 10px 10px rgba(189, 189, 189, 0.22);
}
  ...
  .login-area {
    position: relative;
    /* background-image: url('<?php echo base_url()?>assets/img/coba.png'); */
    background-image: url('<?php echo base_url()?>assets/img/coba.gif');
...
<body>
    ...
    <div class="login-area">
        <div class="container">
            <div class="row">
                <div class="col d-none d-md-block" style="margin-top: 13rem;">
                    <div class="row justify-content-center">
                        <div class="text-center">
                           <img src="<?php echo base_url()?>assets/img/lo_login.png" width="75%"> 
                        </div>
                        <div class="text-center">
                            <img src="<?php echo base_url()?>assets/img/logo-erl-putih.png" width="25%"> 
                        </div>
                    </div>
                </div>
                <div class="col">
