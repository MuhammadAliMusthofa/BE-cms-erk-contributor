...
class menu extends CI_Controller {
	...
	function main()
	{
		...
		$data['get_menu'] = $this->Chart_model->getAllMenu();
        ...
        function listcol(){
            ...
            $colModel['title'] = array('Menu Name',110,TRUE,'left',2);
            $colModel['parent_'] = array('Parent Menu',110,TRUE,'left',2);
            return $colModel;
        }
	...
	function get_flexigrid()
        {
            ...
            $this->db->select("a.id,a.title title, b.title parent_",false)->from($this->utama." a");
            $this->db->join("sv_menu b","b.id=a.id_parents","left");
